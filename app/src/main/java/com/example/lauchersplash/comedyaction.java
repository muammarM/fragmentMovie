...
public class comedyaction extends AppCompatActivity {


    ExoPlayer playerVideo;
    // Ubah nama video sesuai dengan yang ada di folder res/raw
    final String videoResourceName = "komedi1";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_comedyaction);
        if(getSupportActionBar() != null){
            getSupportActionBar().hide();
        }
        PlayerView player = findViewById(R.id.comedyMovie1);
